 ...
 */
{
	"hitLog": {
		...
		"formatHistory": "<textformat leading='-5' tabstops='[25,60,100,210,230]'><font size='12'>×{{n-player}}:<tab>{{dmg-player}}<tab><img src='img://../xvm/res/icons/hitlog/{{dmg-kind}}.png' width='42' height='12'><tab> <img src='img://../xvm/res/icons/class/{{vtype}}3.png' width='12' height='12'><font size='12' color='{{c:vtype}}'>{{vehicle}}</font><tab> {{dead}}<tab><font size='12' color='{{c:t-rating}}'>{{nick}}</font></textformat></font>",
